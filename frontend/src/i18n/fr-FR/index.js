export default {
    ...
    proofTemplate: 'Modèle de Preuve',
    easy: 'Facile',
    medium: 'Moyenne',
    complex: 'Complexe',
    low: 'Basse',
    ...
    templateTags: 'Balises de Template',
    templateTagsDescription: 'Guide de référence pour les balises DOCX utilisées dans la génération de rapports',
    staticTags: 'Balises Statiques',
    staticTagsDescription: 'Balises intégrées toujours disponibles dans les templates',
    dynamicTags: 'Balises Dynamiques',
    auditInfoTags: 'Informations d\'Audit',
    companyTags: 'Entreprise',
    clientTags: 'Client',
    creatorTags: 'Créateur',
    collaboratorsTags: 'Collaborateurs',
    reviewersTags: 'Réviseurs',
    scopeTags: 'Périmètre',
    findingsTags: 'Conclusions',
    cvss3Tags: 'CVSS 3.1 (dans la boucle findings)',
    cvss4Tags: 'CVSS 4.0 (dans la boucle findings)',
    categoriesTags: 'Catégories',
    customSectionTags: 'Sections Personnalisées',
    customSectionTagsDescription: 'Balises de vos sections personnalisées définies dans Données Personnalisées',
    customFieldTags: 'Champs Personnalisés',
    customFieldTagsDescription: 'Balises de vos champs personnalisés définis dans Données Personnalisées',
    auditLevelFields: 'Champs au Niveau de l\'Audit',
    findingLevelFields: 'Champs au Niveau des Conclusions (dans la boucle findings)',
    findingLevelFieldsNote: 'Ces balises doivent être utilisées dans une boucle {#findings}...{/findings}',
    searchTags: 'Rechercher des balises...',
    noTagsFound: 'Aucune balise ne correspond à votre recherche',
    copyTag: 'Copier dans le presse-papiers',
    tagCopied: 'Balise copiée dans le presse-papiers',
