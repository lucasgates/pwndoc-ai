export default {
    ...
    fileTooLarge: 'Datei zu groß. Maximale Größe ist 25MB',
    fileTypeNotAllowed: 'Dateityp nicht erlaubt',
    fileRejected: 'Datei abgelehnt',
    fileUploadedOk: 'Datei erfolgreich hochgeladen',
    fileUploadError: 'Fehler beim Hochladen der Datei',
    fileDownloadError: 'Fehler beim Herunterladen der Datei',
    fileRemovedOk: 'Datei erfolgreich entfernt',
    fileRemoveError: 'Fehler beim Entfernen der Datei',
    ...
    templateTagsDescription: 'Referenzhandbuch für DOCX-Template-Tags in der Berichtserstellung',
    staticTags: 'Statische Tags',
    staticTagsDescription: 'Eingebaute Tags, die immer in Templates verfügbar sind',
    dynamicTags: 'Dynamische Tags',
    auditInfoTags: 'Audit-Informationen',
    companyTags: 'Unternehmen',
    clientTags: 'Kunde',
    creatorTags: 'Ersteller',
    collaboratorsTags: 'Mitarbeiter',
    reviewersTags: 'Prüfer',
    scopeTags: 'Umfang',
    findingsTags: 'Ergebnisse',
    cvss3Tags: 'CVSS 3.1 (innerhalb der Findings-Schleife)',
    cvss4Tags: 'CVSS 4.0 (innerhalb der Findings-Schleife)',
    categoriesTags: 'Kategorien',
    customSectionTags: 'Benutzerdefinierte Abschnitte',
    customSectionTagsDescription: 'Tags aus Ihren benutzerdefinierten Abschnitten in den benutzerdefinierten Daten',
    customFieldTags: 'Benutzerdefinierte Felder',
    customFieldTagsDescription: 'Tags aus Ihren benutzerdefinierten Feldern in den benutzerdefinierten Daten',
    auditLevelFields: 'Audit-Ebene Felder',
    findingLevelFields: 'Finding-Ebene Felder (innerhalb der Findings-Schleife)',
    findingLevelFieldsNote: 'Diese Tags müssen innerhalb einer {#findings}...{/findings} Schleife verwendet werden',
    searchTags: 'Tags suchen...',
    noTagsFound: 'Keine Tags entsprechen Ihrer Suche',
    copyTag: 'In die Zwischenablage kopieren',
    tagCopied: 'Tag in die Zwischenablage kopiert',
