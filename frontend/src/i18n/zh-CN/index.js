export default {
    ...
    fileRejected: '文件被拒绝',
    fileUploadedOk: '文件上传成功',
    fileUploadError: '文件上传错误',
    fileDownloadError: '文件下载错误',
    fileRemovedOk: '文件删除成功',
    fileRemoveError: '文件删除错误',
    ...
    templateTags: '模板标签',
    templateTagsDescription: '用于报告生成的DOCX模板标签参考指南',
    staticTags: '静态标签',
    staticTagsDescription: '模板中始终可用的内置标签',
    dynamicTags: '动态标签',
    auditInfoTags: '审计信息',
    companyTags: '公司',
    clientTags: '客户',
    creatorTags: '创建者',
    collaboratorsTags: '协作者',
    reviewersTags: '审核者',
    scopeTags: '范围',
    findingsTags: '发现',
    cvss3Tags: 'CVSS 3.1 (在findings循环内)',
    cvss4Tags: 'CVSS 4.0 (在findings循环内)',
    categoriesTags: '类别',
    customSectionTags: '自定义部分',
    customSectionTagsDescription: '来自自定义数据中定义的自定义部分的标签',
    customFieldTags: '自定义字段',
    customFieldTagsDescription: '来自自定义数据中定义的自定义字段的标签',
    auditLevelFields: '审计级别字段',
    findingLevelFields: '发现级别字段 (在findings循环内)',
    findingLevelFieldsNote: '这些标签必须在 {#findings}...{/findings} 循环内使用',
    searchTags: '搜索标签...',
    noTagsFound: '没有匹配的标签',
    copyTag: '复制到剪贴板',
    tagCopied: '标签已复制到剪贴板',
