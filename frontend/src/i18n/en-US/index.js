export default {
    ...
    fileTooLarge: 'File too large. Maximum size is 25MB',
    ...
    fileRemovedOk: 'File removed successfully',
    ...
    templateTagsDescription: 'Reference guide for DOCX template tags used in report generation',
    staticTags: 'Static Tags',
    staticTagsDescription: 'Built-in tags always available in templates',
    dynamicTags: 'Dynamic Tags',
    auditInfoTags: 'Audit Information',
    companyTags: 'Company',
    clientTags: 'Client',
    creatorTags: 'Creator',
    collaboratorsTags: 'Collaborators',
    reviewersTags: 'Reviewers',
    scopeTags: 'Scope',
    findingsTags: 'Findings',
    cvss3Tags: 'CVSS 3.1 (inside findings loop)',
    cvss4Tags: 'CVSS 4.0 (inside findings loop)',
    categoriesTags: 'Categories',
    customSectionTags: 'Custom Sections',
    customSectionTagsDescription: 'Tags from your custom sections defined in Custom Data',
    customFieldTags: 'Custom Fields',
    customFieldTagsDescription: 'Tags from your custom fields defined in Custom Data',
    auditLevelFields: 'Audit-Level Fields',
    findingLevelFields: 'Finding-Level Fields (inside findings loop)',
    findingLevelFieldsNote: 'These tags must be used inside a {#findings}...{/findings} loop',
    searchTags: 'Search tags...',
    noTagsFound: 'No tags match your search',
    copyTag: 'Copy to clipboard',
